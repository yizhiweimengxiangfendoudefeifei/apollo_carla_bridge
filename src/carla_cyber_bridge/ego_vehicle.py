...
class EgoVehicle(Vehicle):
    ...
    def control_command_updated(self, cyber_vehicle_control, manual_override):
        ...
        If the mode is valid (either normal or manual), the received cyber message is
        ...
        It's just forwarding the cyber input to CARLA

        :param manual_override: manually override the vehicle control command
        :param cyber_vehicle_control: current vehicle control input received via cyber
